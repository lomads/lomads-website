            ...
            <div style={{ height: '100vh', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div className="scale">
                    ...
                    <p className='contributors-p'>Meet our core contributors and backers.</p>
                        <div centerMode={false} className='contributor-row' {...settings}>
                            <div key={"Nishant"} className='contributor-card' style={{ transform: 'rotate(-10.65deg) !important', zIndex: '1' }} onClick={() => { window.open("https://twitter.com/nbhaskar888") }}>
                            ...
                            <div className='contributor-card' style={{ transform: 'rotate(-0.71deg)', zIndex: '8' }} onClick={() => { window.open("https://twitter.com/aethe_re") }}>
                            ...
                            {/* <div className='contributor-card' style={{ transform: 'rotate(5.84deg)', zIndex: '8' }} onClick={() => { window.open("https://twitter.com/HypnoJimmy") }}>
                            ...
                            <div className='contributor-card' style={{ transform: 'rotate(-0.71deg)', zIndex: '8' }} onClick={() => { window.open("https://www.linkedin.com/in/fernandobcruzperez/") }}>
