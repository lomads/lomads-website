...
const Web3 = () => {
    ...
    return (
        <section className='web3-container'>
            ...
            {<button style={{marginTop:100}} data-speed={window.innerWidth > 1024 ? "0.9" : "1"} onClick={() => { window.location.href = "/earlyAccess" }}>JOIN OUR WAITLIST <HiOutlineArrowRight size={22} /></button>}         
        </section>
    )
}
