        ...
        <section className="banner-container">
            <div className="heading-section">
                <div className="heading-container">
                    <h1 data-speed={window.innerWidth > 1024 ? "1.2" : "1"} className="animate__animated animate__fadeIn animate__fast">WHERE CAPITAL</h1>
                    <h1 data-speed={window.innerWidth > 1024 ? "1.2" : "1"} className="animate__animated animate__fadeIn animate__fast">AND PEOPLE <span>TANGO</span></h1>
                    <h1 data-speed={window.innerWidth > 1024 ? "1.2" : "1"} className="animate__animated animate__fadeIn animate__fast"><span>TO GREATNESS</span></h1>
                </div>
