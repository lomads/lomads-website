...
const Power = () => {
    ...
    return (
        <section className="power-container">
            <img src={powerimg} />
            <h1 className="power-title" data-speed="1.1">
                one <span> power-packed</span><br />
                Token
            </h1>

            <div className="power-content-container">
                <p className="power-content" data-speed="1">You will be assigned a pass token for each organization you work for.<br />This unique token has three key features.</p>
            </div>
            <div className="power-section-container">
                <div className="power-section" data-speed="1">
